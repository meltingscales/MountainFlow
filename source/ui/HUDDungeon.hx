...
class HUDDungeon extends FlxTypedGroup<FlxSprite>
{
	...
	public function new()
	{
		...
		moneyIcon = new FlxSprite(FlxG.width - 12, (moneyCounter.y + (moneyCounter.height / 2) - 4), AssetPaths.monsterEnergy__png);
